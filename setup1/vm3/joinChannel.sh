...
setGlobalsForPeer0Org3() {
    ...
    export CORE_PEER_ADDRESS=localhost:9056
...
fetchChannelBlock() {
    ...
    peer channel fetch 0 ./channel-artifacts/$CHANNEL_NAME.block -o localhost:9050 \
...
updateAnchorPeers() {
    ...
    # Replace localhost with your orderer's vm IP address
    peer channel update -o localhost:9050 --ordererTLSHostnameOverride orderer.example.com \
